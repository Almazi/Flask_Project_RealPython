...
def home():
    ...
    for row in qur.fetchall():
        ...
        posts.append(dict(title = row[0], description = row[1])) #title is taken from row[0] of all fetched tuple data description is taken from row[1] of all fethced data
